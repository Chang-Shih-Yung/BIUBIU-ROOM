...
export default class TopChair
{
    ...
    setModel()
    {
        ...
        this.model.group.traverse((_child) =>
        {
            if(_child instanceof THREE.Mesh)
            {
                ...
                _child.material = new THREE.MeshStandardMaterial({ color: 0x000000, transparent: true, opacity: 0 })
            }
        })
    }
    ...
    update()
    {
        this.model.group.rotation.y = Math.sin(this.time.elapsed * 0.0001) * 0.2 * Math.PI
