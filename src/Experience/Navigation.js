...
export default class Navigation
{
    ...
    setView()
    {
        ...
        this.view.spherical = {}
        //畫面一進入的縮放
        this.view.spherical.value = new THREE.Spherical(15, Math.PI * 0.5, - Math.PI * 0)
        ...
        //縮放遠近
        this.view.spherical.limits.radius = { min: 1, max: 5 }
        //上下旋轉範圍
        this.view.spherical.limits.phi = { min: 1.35, max: 1.5 }
        //左右旋轉範圍
        this.view.spherical.limits.theta = { min: 0.01, max: 0.13 }

        this.view.target = {}
        this.view.target.value = new THREE.Vector3(1, 4, 2.5)
        ...
        // Ignore middle mouse button滑鼠中鍵
        //這個方法意思是：如果滑鼠按鈕是1，則返回
        if (_event.button === 1) {
            return
        }
         ...
         * Wheel
         */
        const zoomSensitivityFactor = 10.1;
        ...
        this.view.onWheel = (_event) =>
        {
            ...
            this.view.zoomIn(normalized.pixelY * zoomSensitivityFactor)
}
        
            //意思:當滑鼠滾輪滾動時，觸發onWheel事件
